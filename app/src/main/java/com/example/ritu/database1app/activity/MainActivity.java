...
//        contactModels = db.getAllRecords();
    ...
    private class fetchData extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                URL url = new URL("https://www.googleapis.com/books/v1/volumes?filter=free-ebooks&q=a");
                ...
                // main google JSON is the object
                JSONObject jsonDATA = new JSONObject(forecastJsonStr);

                // get the  "items" array from the main object
                //JSONArray jsonArray1 = new JSONArray(forecastJsonStr);
                ...
                for (int i = 0; i < jsonArrayLength; i++) {
                    ...
                    contactModel.setEmail(jsonObject.getString("etag"));
                    contactModel.setName(jsonObject.getJSONObject("volumeInfo").getString("title"));
                    contactModel.setPhone(jsonObject.getJSONObject("volumeInfo").getString("pageCount"));
                    contactModel.setImageURL(jsonObject.getJSONObject("volumeInfo").getJSONObject("imageLinks").getString("thumbnail"));
